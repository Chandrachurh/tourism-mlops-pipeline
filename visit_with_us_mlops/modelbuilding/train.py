...
numeric_features = [
    'DurationOfPitch', 'NumberOfFollowups', 'PreferredPropertyStar', 'NumberOfTrips', 'NumberOfChildrenVisiting', 'Age', 'MonthlyIncome'
]
...
with mlflow.start_run():
    ...
    repo_id = "chandrachurhghosh/tourism_project_rf"
    repo_type = "model"
